...
module.exports = {
  ...
  // id_ban_commune
  'id_ban_commune.type_invalide': 'La valeur de l’id_ban_commune n’est pas un uuidv4 valide',
  ...
  'row.incoherence_id_ban': 'Les id ban renseignés ne sont pas cohérents avec les données de la base adresse nationale',
