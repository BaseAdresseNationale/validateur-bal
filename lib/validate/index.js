...
function validateRows(parsedRows, {aliasedFields, unknownFields}) {
  ...
  return {validatedRows, hasErrors, rowsWithIssues}
}

function validateGlobal({fileValidation, aliasedFields, notFoundFields, hasErrors}) {
...
async function validate(file, options) {
  ...
  const {validatedRows, hasErrors, rowsWithIssues} = validateRows(parsedRows, {aliasedFields, unknownFields})
  const {isValid} = validateGlobal({fileValidation, aliasedFields, notFoundFields, hasErrors})
